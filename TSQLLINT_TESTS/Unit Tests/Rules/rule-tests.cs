...
namespace TSQLLINT_LIB_TESTS.Unit_Tests.Rules
{
    public class SelectStarRuleTests
    {
        ...
        [TestCase("disallow-cursors", typeof(DisallowCursorRule), "disallow-cursors-one-error", 1)]
        [TestCase("disallow-cursors", typeof(DisallowCursorRule), "disallow-cursors-two-errors", 2)]
        ...
        [TestCase("semicolon-termination", typeof(SemicolonTerminationRule), "statement-semicolon-termination-try-catch-while", 0)]
