mkdir coverage
.\packages\OpenCover.4.6.519\tools\OpenCover.Console.exe -excludebyattribute:*.ExcludeFromCodeCoverage* -register:user -output:.\coverage\coverage_results.xml "-target:.\packages\NUnit.ConsoleRunner.3.6.1\tools\nunit3-console.exe" "-targetargs:.\TSQLLint.Tests\bin\Release\TSQLLint.Tests.dll"
