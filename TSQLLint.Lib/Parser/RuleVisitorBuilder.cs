...
namespace TSQLLint.Lib.Parser
{
    public class RuleVisitorBuilder : IRuleVisitorBuilder
    {
        ...
        public List<TSqlFragmentVisitor> BuildVisitors(string sqlPath, List<IExtendedRuleException> ignoredRules)
        {
        ...
        private static bool IsRuleIgnored(List<IExtendedRuleException> ignoredRules, string ruleName, int startLne)
        {
        ...
        private void HandleRuleViolation(string sqlPath, List<IExtendedRuleException> ignoredRules, string ruleName, int startLne, string ruleText, int startColumn)
        {
