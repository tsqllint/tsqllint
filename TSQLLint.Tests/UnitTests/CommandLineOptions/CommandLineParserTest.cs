...
namespace TSQLLint.Tests.UnitTests.CommandLineOptions
{
    public class CommandLineParserTest
    {
        ...
        public void ParsesSingleFile()
        {
            ...
            // act
            var commandLineOptions = new Console.CommandLineOptions.CommandLineOptions(args);
        ...
        public void GeneratesUsage()
        {
            ...
            // act
            var commandLineParser = new Console.CommandLineOptions.CommandLineOptions(args);
